...
public class InstitutionResponseDto {
    ...
    public InstitutionResponseDto( int institutionId,int institutionTypeId,int relTenantInstitutionId, String institutionName, String email, String website, String address1, String address2,  byte[] pictureStream
                                 ) {
        this.institutionId = institutionId;
        this.institutionName = institutionName;
        this.relTenantInstitutionId = relTenantInstitutionId;
