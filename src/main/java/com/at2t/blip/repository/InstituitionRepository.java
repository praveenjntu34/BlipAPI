...
public interface InstituitionRepository extends CrudRepository<Institution, Integer> {
    ...
    @Query("SELECT new com.at2t.blip.dto.InstitutionResponseDto(I.institutionId,RI.institutionTypeID,RI.relTenantInstitutionId, I.institutionName,  I.email, I.website,  AD.address1,  AD.address2,  IDP.pictureStream) \n" +
